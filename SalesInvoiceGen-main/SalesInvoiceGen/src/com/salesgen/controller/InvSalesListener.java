...
import com.salesgen.model.InvLIne;
import com.salesgen.model.InvLineTabModel;
import com.salesgen.view.InvoiceFrame;
import com.salesgen.view.InvHeaderTable;
import com.salesgen.view.InvLineTable;
 ...
 * @author AymanOsama
 */
public class InvSalesListener implements ActionListener, ListSelectionListener  {
    private InvoiceFrame frame;
    private DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
    
    public InvSalesListener(InvoiceFrame frame) {
        this.frame = frame;
    }
    ...
    private void loadFile() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(frame, "select lines file!", "Attension", JOptionPane.WARNING_MESSAGE);
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    frame.setInvoiceHeaderTableModel(new InvHeadTabModel(frame.getInvoicesList()));
    ...
    private void saveData() {
        ...
        JOptionPane.showMessageDialog(frame, "select file to save header data!", "Attension", JOptionPane.WARNING_MESSAGE);
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(frame, "select file to save lines data!", "Attension", JOptionPane.WARNING_MESSAGE);
    ...
    private void invoicesTableRowSelected() {
        ...
        if (selectedRowIndex >= 0) {
            ...
            frame.setInvoiceLinesTableModel(new InvLineTabModel(lines));
    ...
    private void displayNewInvoiceDialog() {
        frame.setHeaderDialog(new InvHeaderTable(frame));
        frame.getHeaderDialog().setVisible(true);
    }

    private void displayNewLineDialog() {
        frame.setLineDialog(new InvLineTable(frame));
    ...
    private void createInvOK() {
        ...
        try {
            ...
            InvHead invoiceHeader = new InvHead(invNum, custName, invDate);
    ...
    private void deleteInvoice() {
        ...
        frame.getInvoiceHeaderTableModel().fireTableDataChanged();
        frame.setInvoiceLinesTableModel(new InvLineTabModel(new ArrayList<InvLIne>()));
        frame.getInvLinesTable().setModel(frame.getInvoiceLinesTableModel());
        frame.getInvoiceLinesTableModel().fireTableDataChanged();
